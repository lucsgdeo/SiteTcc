...
<body>
    ...
    <header>
        ...
        <nav class="nave">
            ...
            <a class="userImg" onclick="abrirMenuUsuario()"><img src="./assets/img/icons8-user-48.png" alt=""></a>

            <div class="hide">
                <h1 class="userTitle">Área do Usuário</h1>
                <img class="imgUser" src="assets/img/icons8-user-48.png" alt="">
                <p class="userNameHide">Usuário</p>
                <img class="imgEmail" src="assets/img/icons8-email-48.png" alt="">
                <p class="userEmailHide">Usuário@email.com</p>
                <a href="index.php" class="userSair">Sair</a>
                <a href="esqueceusenha.html" class="userAlterar">Alterar senha</a>
            </div>

            <div class="mobile-menu-icon-logado">
